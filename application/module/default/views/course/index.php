...
<!--                                <div class="img-thumb">-->
<!--                                    <img src="--><?php //echo $this->linkVideo[0]['thumbnails']?><!--" alt="">-->
<!--                                </div>-->
...
<!--                            </div>-->
                            <div class="video embed-responsive embed-responsive-16by9">
                                <iframe src="https://www.youtube.com/embed/<?php echo $this->video[0]['link']?>" class="embed-responsive-item">
                                </iframe>
                            </div>
                        </div>
                        <div class="price">
                        ...
                        <div class="tab-pane fade" id="outline">
                            ...
                            <div class="section-outline">
                                ...
                                <ul class="section-list">
                                    <?php
                                    $number=1;
                                    foreach ($this->video as $nameVideo){
                                    ...
                                    <li>
                                        ...
                                        <div class="list-body">
                                            ...
                                            <p><a href="#" class="name-video" link="<?php echo $nameVideo['link']?>"><?php echo $nameVideo['title']?></a></p>
...
<!--                                            <div class="data-lessons">-->
<!--                                                <span>15 --><?php //echo $urlImage?><!--</span>-->
<!--                                            </div>-->
<!--                                        </div>-->
<!--                                        <a href="#" class="mc-btn-2 btn-style-2">Preview</a>-->
<!--                                    </li>-->
...
<section id="course-concern" class="course-concern">
    <div class="container">
        ...
        <div class="row">
            <?php
            foreach ($this->category as $nameCategory){
            ...
            <div class="col-xs-6 col-sm-4 col-md-3">
                ...
                <div class="mc-item mc-item-2">
                    ...
                    <div class="content-item">
                        ...
                        <h4><a href="<?php echo URL::createLink('default','courses','index',['id'=>$nameCategory['id']])?>"><?php echo $nameCategory['name']?></a></h4>
                        <div class="name-author">
                            By <a href="#"><?php echo $nameCategory['name_author']?></a>
                        </div>
                    </div>
                    <div class="ft-item">
                        <div class="rating">
